...
class TestDeepseek(unittest.TestCase):
    def setUp(self):
        ...
        self.api = DeepseekBusinessDescriptionAPI(self.api_key)
    ...
    def test_business_description_length(self):
        ...
        word_count = len(response.split())
        self.assertLess(word_count, MAX_WORDS*2, f"Response was {word_count} words, expected less than {MAX_WORDS}")
